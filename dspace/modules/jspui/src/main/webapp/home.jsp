...
<dspace:layout locbar="nolink" titlekey="jsp.home.title" feedData="<%= feedData %>" style="default">
    ...
    <p>You can use DRUM to share and preserve a wide range of research products, such as:</p>
    <ul>
    ...
    <p>You can track views and downloads of your research, and everything in DRUM is indexed by Google and Google Scholar. You receive a permanent, consistent URL for your items, making it easy for other researchers to cite your work.</p>
